    ...
    <>
      <Swiper navigation={true} modules={[Navigation]} className="mySwiper">
        ...
        <section className="bg-stone-700">
            ...
            <div className="lg:w-1/2">
            <div className="max-w-lg mx-auto text-center lg:text-left">
               <h1 className="text-4xl lg:text-6xl font-bold mb-4 text-white hero-heading">Multi-regulated global broker.</h1>
                <p className="hero-paragraph text-lg mb-8 text-white">A trusted destination for traders worldwide, <span className="hide-mobile">Authorised by FCA, ASIC & FSCA</span> </p>
