  ...
  <div className="container mx-auto flex items-center justify-between py-4 px-8">
    ...
    <div className="flex justify-center">
      <div className="rect relative w-96 h-48 border-2 border-gray-200 flex items-center">
        <h2 className="absolute top-0 left-0 right-0 text-center text-lg font-bold text-orange-500 mt-2">Simple steps to start trade</h2>
        <div className="circ flex justify-center mt-12 space-x-8">
          <div className="flex flex-col items-center">
            <div className="w-16 h-16 rounded-full border border-orange-500 border-solid  flex items-center justify-center text-orange-500 text-2xl font-bold mb-2">1</div>
            <p className="text-center text-gray-700">Register account</p>
          </div>
          <div className="flex flex-col items-center">
            <div className="w-16 h-16 rounded-full border border-red-500 border-solid flex items-center justify-center text-orange-500 text-2xl font-bold mb-2">2</div>
            <p className="text-center text-gray-700">Fund your account</p>
          </div>
          <div className="flex flex-col items-center">
            <div className="w-16 h-16 rounded-full border border-red-500 border-solid flex items-center justify-center text-orange-500 text-2xl font-bold mb-2">3</div>
    ...
    <section className="bgh w-full h-full bg-no-repeat bg-cover">
      <div className="flex flex-col md:flex-row ml-20">
        <div className="w-full md:w-1/2 flex justify-center items-center">
          <img src="/in-liquid-3-mockup.png" alt="Laptop" className="w-full mt-5" />
        </div>
        <div className="w-full md:w-1/2 flex flex-col justify-center items-start p-4 md:p-8">
          <p className='text-orange-400 py-3'>AVAILABLE ON MULTIPLE PLATFORM</p>
          <h2 className="text-4xl font-bold mb-4">World class platform <br />
trade without a doubt.</h2>
          <p className="text-lg mb-4">
            Vivamus id sapien vitae urna vestibulum semper. Curabitur eget
            semper tortor. Aliquam posuere nulla a fermentum sagittis. Morbi eu
            ipsum sit amet nisl tempor tempus.
          </p>
    ...
    <div className="blg grid grid-cols-3 gap-10">
      <div className="border-l-2 border-red-400 p-4">
        <div className="flex justify-between">
          <h2 className="text-xl font-bold">Wall Street cautious on 'frothy' stocks, warn bitcoin bubble</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-0">
        <div className="bg-white mt-10 p-4 rounded-lg">
          <img src="in-liquid-award.svg" alt="Image" className="w-1/5 mb-4 rounded-lg m-auto" />
          <h2 className="text-lg font-semibold mb-2 text-center">Best CFD Broker</h2>
          <p className="text-gray-700 text-center">iFX EXPO 2020</p>
        </div>
        <div className="bg-white mt-10 p-4 rounded-lg">
          <img src="in-liquid-award.svg" alt="Image" className="w-1/5 mb-4 rounded-lg m-auto" />
          <h2 className="text-lg font-semibold mb-2 text-center">Best Execution Broker</h2>
          <p className="text-gray-700 text-center">iFX EXPO 2020</p>
        </div>
        <div className="bg-white mt-10 p-4 rounded-lg">
          <img src="in-liquid-award.svg" alt="Image" className="w-1/5 mb-4 rounded-lg m-auto" />
          <h2 className="text-lg font-semibold mb-2 text-center">Best Trading Platform</h2>
          <p className="text-gray-700 text-center">London summit 2020</p>
        </div>
        <div className="bg-white mt-10 p-4 rounded-lg">
          <img src="in-liquid-award.svg" alt="Image" className="w-1/5 mb-4 rounded-lg m-auto" />
          <h2 className="text-lg font-semibold mb-2 text-center">Best Broker Asia</h2>
          <p className="text-gray-700 text-center">iFX EXPO 2020</p>
        </div>
      </div>
    </section>
      ...
      <div className="max-w-2xl w-full p-12">
        <h2 className="text-1xl font-bold mb-12 text-center">Payment Method.</h2>
        <div className="grid grid-cols-6 gap-12">
          <img src="/in-liquid-payment-1.svg" alt="Payment Option 1" className="w-full h-full" />
          <img src="/in-liquid-payment-2.svg" alt="Payment Option 2" className="w-full h-full object-cover" />
          <img src="/in-liquid-payment-3.svg" alt="Payment Option 3" className="w-full h-full object-cover" />
          <img src="/in-liquid-payment-4.svg" alt="Payment Option 4" className="w-full h-full object-cover" />
          <img src="/in-liquid-payment-5.svg" alt="Payment Option 5" className="w-full h-full object-cover" />
          <img src="/in-liquid-payment-6.svg" alt="Payment Option 6" className="w-full h-full object-cover" />
        </div>
      </div>
    </div>
